...
import {
  ...
  getManualBookingEarliestAction,
...
export function ManualBookingForm({
  ...
  const [state, formAction, isPending] = useActionState(createManualAppointmentAction, initialState);
      ...
      {step === "datetime" && selectedService && (
        <div className="flex flex-col gap-4">
          ...
          <SlotPicker
            ...
            timezone={timezone}
            locale={locale}
            getSlots={(dateStr) => getManualBookingSlotsAction(selectedService.id, dateStr)}
            getEarliest={() => getManualBookingEarliestAction(selectedService.id)}
            onSelect={setSlotIso}
