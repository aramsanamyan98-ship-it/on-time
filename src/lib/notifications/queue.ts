 ...
 * appointment is actually over — scheduled for `endAt`. Not plan-gated:
 * reviews (submission and public display alike) are a baseline feature of
 * every paid plan (02_PRD.md Section 14).
 */
